namespace ClientAzureFunction
{
    public static class AppConstant
    {
        public static class Messages
        {
            public const string ApplicationStarted = "🚀 Client Azure Function Started";
            public const string ApplicationStopped = "🛑 Client Azure Function Stopped";
